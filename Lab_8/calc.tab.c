...
{
      -8,     0,    -8,    -8,    10,    17,     1,    10,    10,    10,
      10,    10,    -8,    -8,    21,    21,    -7,    -7,    -7
};
...
{
       2,    11,     0,     3,     0,     7,     8,     9,    10,    11,
       4,     6,    13,     3,    14,    15,    16,    17,    18,     0,
       4,     7,     8,     9,    10,    11,    12,     9,    10,    11
};

static const yytype_int8 yycheck[] =
{
       0,     8,    -1,     3,    -1,     4,     5,     6,     7,     8,
      10,     4,    11,     3,     7,     8,     9,    10,    11,    -1,
...
yyreduce:
  ...
  switch (yyn)
    {
  case 3: /* input: input expression '\n'  */
#line 24 "calc.y"
                            { 
        if (floor((yyvsp[-1].dval)) == (yyvsp[-1].dval)) { 
            printf("Result: %.0lf\n", (yyvsp[-1].dval));
        } else {
            printf("Result: %lf\n", (yyvsp[-1].dval)); 
        }
